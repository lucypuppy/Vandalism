...
public class LongValue extends ValueNumber<Long> {
    ...
    public LongValue(ValueParent parent, String name, String description, Long defaultValue, Long minValue, Long maxValue) {
    ...
    public void load(final JsonObject mainNode) {
        ...
        this.setValue(mainNode.get(this.getName()).getAsLong());
    }
    ...
    @Override
    public void render() {
        final ImLong nextValue = new ImLong(this.getValue());
        ImGui.setNextItemWidth(ImGui.getColumnWidth() - 2);
        if (ImGui.sliderScalar("##" + this.getName() + this.getParent().getName(), ImGuiDataType.S64, nextValue, this.getMinValue(), this.getMaxValue())) {
