...
public class GreedyPlayerArgumentType implements ArgumentType<String>, MinecraftWrapper {

    public static GreedyPlayerArgumentType create() {
        return new GreedyPlayerArgumentType();
    }
