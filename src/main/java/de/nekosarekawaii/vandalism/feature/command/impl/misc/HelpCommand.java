...
public class HelpCommand extends AbstractCommand {
    ...
    public void build(final LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(argument("page", IntegerArgumentType.integer(0)).executes(context -> {
            ...
            int page = Math.max(0, Math.min(IntegerArgumentType.getInteger(context, "page") - 1, maxPages));
