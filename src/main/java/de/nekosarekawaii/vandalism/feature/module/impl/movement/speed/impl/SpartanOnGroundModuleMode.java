...
public class SpartanOnGroundModuleMode extends ModuleMulti<SpeedModule> implements PlayerUpdateListener {
    ...
    private final DoubleValue speed = new DoubleValue(
            this,
            "Speed",
            "The speed amount of the on ground speed.",
            1.2,
            1.0,
            5.0
    );

    public SpartanOnGroundModuleMode() {
        super("Spartan On Ground");
    }
