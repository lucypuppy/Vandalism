...
public class CheatGuardModuleMode extends ModuleMulti<SpeedModule> implements PlayerUpdateListener {

    private final DoubleValue speed = new DoubleValue(
            this,
            "Speed",
            "The speed amount of the cheatguard speed.",
            6.0,
            1.0,
            9.0
    );

    public CheatGuardModuleMode() {
        super("CheatGuard");
    }
