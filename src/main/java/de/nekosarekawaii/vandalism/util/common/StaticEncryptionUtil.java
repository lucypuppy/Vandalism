...
public class StaticEncryptionUtil {
     ...
     */
    private static final String SALT = "xOtlS4y3F9e0o89$LsetrR$R89u";

    public static String encrypt(final String key, final String data) throws InvalidKeySpecException {
        return EncryptionUtils.aes(INIITAL_VECTOR, EncryptionUtils.fromString(SALT + key)).encrypt(data);
    }

    public static String decrypt(final String key, final String data) throws InvalidKeySpecException {
        return EncryptionUtils.aes(INIITAL_VECTOR, EncryptionUtils.fromString(SALT + key)).decrypt(data);
    }
