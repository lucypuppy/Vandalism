...
public class V2iUniform extends Uniform<Vec2i> {

    public V2iUniform(final int programID, final String uniformName) {
        super(programID, uniformName);
    }

    @Override
    public void apply() {
        GL20C.glUniform2i(this.location, this.value.x, this.value.y);
    }
