...
public class V2fUniform extends Uniform<Vec2f> {

    public V2fUniform(final int programID, final String uniformName) {
        super(programID, uniformName);
    }

    @Override
    public void apply() {
        GL20C.glUniform2f(this.location, this.value.x, this.value.y);
    }
