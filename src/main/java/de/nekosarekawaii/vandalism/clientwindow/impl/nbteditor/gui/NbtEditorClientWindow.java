...
package de.nekosarekawaii.vandalism.clientwindow.impl.nbteditor.gui;

import de.nekosarekawaii.vandalism.Vandalism;
import de.nekosarekawaii.vandalism.clientwindow.base.ClientWindow;
import de.nekosarekawaii.vandalism.clientwindow.impl.nbteditor.NbtEditorManager;
import imgui.ImGui;
...
public class NbtEditorClientWindow extends ClientWindow {

    private final NbtEditorManager nbtEditorManager;

    public NbtEditorClientWindow() {
    ...
    public void displayNbt(final String name, final NbtCompound nbt) {
        try {
            ...
            stream.close();
            setActive(true);
            Vandalism.getInstance().getClientWindowManager().openScreen();
