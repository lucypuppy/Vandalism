...
package de.nekosarekawaii.vandalism.clientwindow.impl.nbteditor;
...
public class NbtEditorManager implements ImNbtDrawer, MinecraftWrapper {
    ...
    @Override
    public void exit() {
        Vandalism.getInstance().getClientWindowManager().getByClass(NbtEditorClientWindow.class).setActive(false);
    }
