...
public abstract class MixinSliderWidget extends ClickableWidget {
    ...
    public MixinSliderWidget(final int x, final int y, final int width, final int height, final Text message) {
    ...
    private void drawClientSlider1(final DrawContext drawContext, final Identifier identifier, final int x, final int y, final int u, final int v) {
    ...
    private void drawClientSlider2(final DrawContext drawContext, final Identifier identifier, final int x, final int y, final int u, final int v) {
        final MenuSettings menuSettings = Vandalism.getInstance().getClientSettings().getMenuSettings();
        if (!menuSettings.customWidgets.getValue()) {
            drawContext.drawGuiTexture(identifier, x, y, u, v);
            return;
