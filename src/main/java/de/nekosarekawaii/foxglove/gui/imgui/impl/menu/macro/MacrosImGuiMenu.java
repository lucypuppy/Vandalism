package de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro;

import de.nekosarekawaii.foxglove.gui.imgui.ImGuiMenu;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.InputNode;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.Node;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.NodeTypes;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.OutputNode;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.impl.OnDisableNode;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.impl.OnEnableNode;
import de.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.impl.SendChatMessageNode;
import imgui.ImGui;
