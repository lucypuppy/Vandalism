...
import de.foxglovedevelopment.foxglove.feature.impl.module.impl.movement.modes.elytraflight.CreativeModuleMode;
...
public class ElytraFlightModule extends Module implements TickListener {
    ...
    public void onTick() {
        ...
        if (itemStack.getItem() != Items.ELYTRA || !ElytraItem.isUsable(itemStack)) {
            ChatUtils.errorChatMessage(Text.literal("You need to equip an elytra to fly."));
            this.setState(false);
        }
    }
