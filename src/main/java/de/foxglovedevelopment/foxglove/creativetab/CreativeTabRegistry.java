package de.foxglovedevelopment.foxglove.creativetab;

import de.florianmichael.dietrichevents2.DietrichEvents2;
import de.florianmichael.dietrichevents2.Priorities;
import de.foxglovedevelopment.foxglove.Foxglove;
import de.foxglovedevelopment.foxglove.creativetab.impl.CrashItemsCreativeTab;
import de.foxglovedevelopment.foxglove.creativetab.impl.GriefItemsCreativeTab;
import de.foxglovedevelopment.foxglove.creativetab.impl.KickItemsCreativeTab;
import de.foxglovedevelopment.foxglove.creativetab.impl.TrollItemsCreativeTab;
        ...
        for (int i = 0; i < creativeTabs.length; i++) {
            ...
            if (!this.creativeTabs.contains(creativeTab)) {
                ...
                Registry.register(Registries.ITEM_GROUP, new Identifier(
                                Foxglove.getInstance().getLowerCaseName(),
                                Integer.toString(i)),
                        itemGroup
                );
            }
