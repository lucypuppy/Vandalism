...
public class Http {
    ...
    public static class Request {
        ...
        public Request bearer(final String token) {
            builder.header("Authorization", "Bearer " + token);

            return this;
        }

        public Request bodyString(final String string) {
        ...
        public Request bodyForm(final String string) {
        ...
        public Request bodyJson(final String string) {
        ...
        public Request bodyJson(final Object object) {
            builder.header("Content-Type", "application/json");
        ...
        private <T> T _send(final String accept, final HttpResponse.BodyHandler<T> responseBodyHandler) {
        ...
        public <T> T sendJson(final Type type) {
            final InputStream in = _send("application/json", HttpResponse.BodyHandlers.ofInputStream());
