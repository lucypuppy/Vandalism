package me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro;
...
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.InputNode;
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.Node;
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.NodeTypes;
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.OutputNode;
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.impl.OnDisableNode;
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.impl.OnEnableNode;
import me.nekosarekawaii.foxglove.gui.imgui.impl.menu.macro.node.impl.SendChatMessageNode;
...
public class MacrosMenu {
    ...
    private final static NodeEditorContext CONTEXT;
    ...
    static {
        ...
        macros.add(new Macro("Test", "Just a test."));
        macros.add(new Macro("Test 2", "Just a second test."));
    }
    ...
    private static void renderNodeEditor(final Macro macro) {
